...
import it.niedermann.nextcloud.tables.types.manager.factories.number.NumberManagerFactory;
...
public class NumberDescriptor extends DataTypeDescriptor {
    ...
    private NumberDescriptor(
        ...
        super(viewHolderFactory, editorFactory, columnCreator, new NumberManagerFactory());
    }
}
