...
import it.niedermann.nextcloud.tables.types.manager.factories.number.NumberStarsManagerFactory;
...
public class StarsDescriptor extends DataTypeDescriptor {
    ...
    private StarsDescriptor(
        ...
        super(viewHolderFactory, editorFactory, columnCreator, new NumberStarsManagerFactory());
    }
}
