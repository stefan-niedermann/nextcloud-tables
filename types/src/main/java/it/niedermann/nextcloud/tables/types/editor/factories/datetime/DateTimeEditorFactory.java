...
import it.niedermann.nextcloud.tables.types.editor.type.datetime.DateTimeEditor;

public class DateTimeEditorFactory extends AbstractEditorFactory {

    public DateTimeEditorFactory(@NonNull DefaultValueSupplier defaultValueSupplier) {
    ...
    public ColumnEditView create(@NonNull Context context,
        ...
        return new DateTimeEditor(context, fragmentManager, column, data, defaultValueSupplier);
    }
}
