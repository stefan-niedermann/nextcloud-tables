...
import it.niedermann.nextcloud.tables.types.editor.type.datetime.DateTimeDateEditor;

public class DateEditorFactory extends AbstractEditorFactory {

    public DateEditorFactory(@NonNull DefaultValueSupplier defaultValueSupplier) {
    ...
    public ColumnEditView create(@NonNull Context context,
        ...
        return new DateTimeDateEditor(context, fragmentManager, column, data, defaultValueSupplier);
    }
}
