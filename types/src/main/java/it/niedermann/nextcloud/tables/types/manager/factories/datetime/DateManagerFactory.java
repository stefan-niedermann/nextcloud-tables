...
import it.niedermann.nextcloud.tables.types.manager.type.datetime.DateManager;

public class DateManagerFactory implements ManageFactory {
    ...
    public ColumnManageView create(@NonNull Context context,
        ...
        return new DateManager(context, column, fragmentManager);
    }
}
