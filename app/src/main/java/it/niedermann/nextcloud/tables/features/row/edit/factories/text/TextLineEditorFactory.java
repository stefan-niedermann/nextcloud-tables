...
import it.niedermann.nextcloud.tables.features.row.edit.type.text.TextLineEditor;

public class TextLineEditorFactory implements EditorFactory<EditTextviewBinding> {
    ...
    public DataEditView<EditTextviewBinding> create(@NonNull Context context,
        ...
        return new TextLineEditor(context, fullColumn.getColumn());
    }
}
