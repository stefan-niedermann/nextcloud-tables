package it.niedermann.nextcloud.tables.features.row.edit.factories.number;
...
import it.niedermann.nextcloud.tables.features.row.edit.type.number.NumberProgressEditor;
