...
import it.niedermann.nextcloud.tables.features.row.edit.type.text.TextLinkEditor;

public class TextLinkEditorFactory implements EditorFactory<EditTextviewBinding> {
    ...
    public DataEditView<EditTextviewBinding> create(@NonNull Context context,
        ...
        return new TextLinkEditor(context, fullColumn.getColumn());
    }
}
